/**
 * PURE TYPESCRIPT INTERFACES FOR HRMS ADMIN PORTAL
 * No React component code. Ready for export.
 */
...
export interface AppEvent {
  ...
  endTime: string;
  isOnline: boolean;
  location: string; // Link if online, Address if offline
  audience: EventAudience;
  targetEmployeeIds: string[]; // Only for 'selected'
  targetDepartment?: string; // Only for 'department'
  status: EventStatus;
