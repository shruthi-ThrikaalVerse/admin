  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-3 pointer-events-none">
      {(notifications || []).map((n) => (
        <div
          key={n.id}
          className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-2xl shadow-2xl border min-w-[300px] animate-in slide-in-from-right-full duration-300 ${
        ...
        >
          ...
          <button onClick={() => dismissNotification(n.id)} className="p-1 hover:bg-gray-100 rounded-lg text-gray-300 transition-colors">
